...
function Hero() {
  ...
  return (
    <div className="flex flex-col items-center mx-10 sm:mx-56 gap-9 cursor-pointer">
      <h1 
        className="font-extrabold sm:text-[50px] text-[30px] text-center mt-16"
        data-aos="fade-down"
      >
        <span 
      ...
      <div className='flex flex-col sm:flex-row gap-5 w-full justify-center' data-aos="fade-up" data-aos-delay="600">
        <img src={laptop} alt="Laptop" data-aos="flip-left" data-aos-delay="700" />
        <img src={phone} alt="Phone" data-aos="flip-right" data-aos-delay="800" />
      </div>
